...
@RestController
@RequestMapping("/api/j-hipsteer-test-app-kafka")
public class JHipsteerTestAppKafkaResource {

    private final Logger log = LoggerFactory.getLogger(JHipsteerTestAppKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public JHipsteerTestAppKafkaResource(KafkaProperties kafkaProperties) {
